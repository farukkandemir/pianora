...
2. Build (stdlib Python, ~3 s):
   `python3 build_sf2.py <extracted folder> salamander-8v.sf2 8 7.5 1.5`
   Arguments: velocity layers (of 16), max seconds per sample, fade seconds.
   8 layers x 7.5 s = 287 MB (under the 300 MB dashboard upload limit). The full set would be 1.1 GB.
...
7c93ca1e01e901407f7bb62061cf8d5818cbb63224f20d27605d49aed5af893a
